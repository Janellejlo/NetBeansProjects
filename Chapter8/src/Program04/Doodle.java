...
/**
 * This is a simple predator-prey Simulation with Ants(Prey) and DoodleBugs(Predator)
 *         existing on an Array of GridPoints
 * 
 *  Both the Ants and DoodleBugs reproduce after a number of turns,
 *        Only the Doodlebugs may eat the Ants
 *        Simulation Continues until one species is extinct
 * 
 */
public class Doodle {
